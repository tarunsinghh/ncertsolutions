...
<p>i) Using Euclid's algorithm :</p>
...
<p>This is the most important step to understand </p>
<p>Please give some to it ,if you dint get it in the first look</p>
<p>so H.C.F of (135,225) is 45.</p>
<p>&nbsp;</p>
<p>ii) We start with the larger number i.e 38220</p>
<p>By Euclid’s division algorithm,we have</p>
<p>38220=196\(\times\)195+0</p>
<p>196=196\(\times\)1+0</p>
<p>Hence , HCF(196,38220)=196</p>
<p>Now I am not going to repeat the same procedure again,please see part1</p>
<p>Therefore,the HCF of 196 and 38220 is 196</p>
<p>&nbsp;</p>
<p>iii) We start with the larger number i.e 867</p>
<p>By Euclid’s division algorithm,we have</p>
...
<p>Show that any positive odd integer is of the form 6q+1,6q+3 &amp; 6q+5</p>
<p>where q is some integer.</p>
<p>&nbsp;</p>
<p><strong>Solution :</strong></p>
...
<p>Now 45 = 6* 7 + 3,which is of the form 6q+ 3.</p>
<p>Now 47 = 6* 7 + 5,which is of the form 6q+ 5.</p>
<p>Now 43 = 6* 7 + 1,which is of the form 6q+ 1.</p>
<p>Now 42 = 6* 7 ,which is of the form 6q.</p>
<p>Now 44 = 6* 7 + 2,which is of the form 6q + 2.</p>
<p>Now 46 = 6* 7 + 4,which is of the form 6q + 4.</p>
<p><strong>Question 3:</strong></p>
<p>An army contingent of 616 members is to march behind an army band of 32 members in a parade. The two groups are to march in the same number of columns. What is the maximum number of columns in which they can march?</p>
<p>&nbsp;</p>
<p><strong>Solution :</strong></p>
...
<p>Use Euclid’s Division lemma to show that the square of any positive integer is either of the form 3m, 3m+1 for some integer m.</p>
...
<p>\(x^{2} = 16q^{2} + 4 + 16q\)</p>
<p>\(x^{2} = 16q^{2} + 9 + 24q\)</p>
<p>Lets try to rewrite them into the form 3 * some integer  or 3 * some integer + 1</p>
<p>\(x^{2} = 3 * ( 16/3\times q^{2})\) </p> 
...
<p><strong>Note: Both 16 and 20 are of the form 4*q but 256 can be written in the form of 3m and 400 can be written in the form 3m + 1 which depends on what q is so  we have to consider sub cases based  on q when we write in the factor of 4,this thing is easier to show when we write in the form of 3q,3q + 1 ,3q + 2,since we can take out easily in the factor of 3 and we dont have to make sub cases based in the value of q</strong></p>
...
<p>Hence prooved.</p>
<p><strong>Note:Like previous question ,we can express the number into other form also we can express like
x = 5q,x = 5q + 1....so on ,But the only challenge will remain is to show that when m is an integer,for some values of q
we can write it in the form of 9m,for other values of q we can write it in the form of 9m + 1,when we write the number in the form of 3q,3q + 1,3q + 2,its easier to show m is an integer irrespective of what q is</strong></p>
...
<p><strong>Note:Now if this question comes in exams and if a student directly answers it by finding L.C.M using prime factorization method<br>
<p>The chances are that teacher might give him no marks</p></strong></p>
...
<p><strong>The following statement is important,if you will not write it,you may loose marks</strong></p>
...
<p><strong>You can see the proof of if a divides \(p^{2}\) then a divides p which is not from examination point of view,but we highly recommend you see that proof in ncert examples,so simialr arguement holds for \(p^{n}\)</strong></p>
...
<p><strong>Note:This theorem is prooved in the ncert 
...
And also challenge things why it id true,I need proof</strong></p>
...
<p><strong>Question 3:</strong></p>
<p>Decide whether the real numbers are rational or not. If they are rational ,then write its \(\frac{p}{q}\) form.What can you say about the prime factors of q?</p>
<p>i)43.123456789</p>
